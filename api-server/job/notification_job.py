...
class NotificationJob:
    def __init__(self, webhook, secret=None, pc_slide=False, fail_notice=False, LarktalkChatbot=None):
        '''
        机器人初始化
        ...
        '''
        super(LarktalkChatbot, self).__init__()
        ...
        def post(self, data):
            ...
            try:
                ...
                logging.error(
                    "消息发送失败， HTTP error: %d, reason: %s" % (exc.response.status_code, exc.response.reason))
                raise
